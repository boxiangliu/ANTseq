...
```
plink --vcf sample1.snps.indels.vcf --double-id --snps-only --keep-allele-order --make-bed --out sample1.snps
```

#### TODO ####

1. how to merge two plink bed files. 
2. add admixture command example. 
